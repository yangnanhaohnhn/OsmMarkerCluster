 ...
 */
package com.osm.mapapi.clusterutil.projection;
...
public class SphericalMercatorProjection {
    ...
    public Point toPoint(final GeoPoint latLng) {
    ...
    public GeoPoint toLatLng(com.osm.mapapi.clusterutil.projection.Point point) {
